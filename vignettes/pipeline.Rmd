...
That actually 9 times the number of cells in this experiment: each compartment
and each channel gets its own row. Here, we have 3 compartments (cell, nucleus, 
cytoplasm) and 3 channels (CellMask, Hoechst, Alexa568).
